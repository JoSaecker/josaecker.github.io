---
title: "Macroeconomics 2 (Tutorial)"
collection: teaching
type: "Bachelor"
permalink: /teaching/pmak
...
Although the emphasis is on presenting the intuition behind macro theory, we will be using a combination of figures and mathematics to derive results, with more emphasis on mathematics than in intermediate-level macroeconomics. Knowledge of functions, derivatives, and constrained optimization, along with basic statistics is assumed.

Instructors: Prof. Dr. A. Meyer-Gohde (exception: Prof. Dr. M. Trabandt in Fall 2021)
Dates: Fall 2018, Spring 2019, Fall 2019, Spring 2020, Fall 2020, Spring 2021, Fall 2021, Spring 2022, Spring 2024
